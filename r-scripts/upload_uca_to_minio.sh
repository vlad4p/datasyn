...
#   UCA_LOCAL_DIR=/path/to/uca ./infra/dagster/mcp/dagster-code/projects/datasyn/scripts/r/upload_uca_to_minio.sh
#   FORCE=1 ./infra/dagster/mcp/dagster-code/projects/datasyn/scripts/r/upload_uca_to_minio.sh
#
