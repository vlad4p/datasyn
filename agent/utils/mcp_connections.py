...
Docker Compose uses internal DNS (``duckdb-mcp``, ``scrapper-mcp``, …). Those names only
...
# Hostnames from ``mcp.json`` that map to published ports in ``mcp_servers/docker-compose.yaml``.
